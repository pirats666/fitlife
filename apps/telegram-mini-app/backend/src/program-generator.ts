...
const templates:Template[]=[
 {name:"Приседание с собственным весом",tags:["home","street","gym"],muscleGroups:["quadriceps","glutes"],focus:"legs",pattern:"squat",blocked:["колен","тазобедрен","голеностоп"],aspects:["hypertrophy","strength","endurance","maintenance","general_fitness","weight_management"]},
 {name:"Отжимания",tags:["home","street","gym"],muscleGroups:["chest","triceps","shoulders"],focus:"chest",pattern:"horizontal_push",blocked:["плеч","запяст","локт"],aspects:["hypertrophy","strength","endurance","maintenance","general_fitness","weight_management"]},
 {name:"Тяга верхнего блока",tags:["gym"],muscleGroups:["lats","upper_back","biceps"],focus:"back",pattern:"vertical_pull",equipment:["блок","кроссовер","тренажер"],blocked:["плеч","локт"],aspects:["hypertrophy","strength","endurance","maintenance","general_fitness"]},
 {name:"Good Morning без веса",tags:["home","street","gym"],muscleGroups:["hamstrings","glutes","upper_back"],focus:"back",pattern:"hinge",blocked:["поясниц","спин"],aspects:["hypertrophy","strength","endurance","maintenance","general_fitness"]},
 {name:"Выпады назад",tags:["home","street","gym"],muscleGroups:["quadriceps","glutes","hamstrings"],focus:"legs",pattern:"squat",blocked:["колен","тазобедрен","голеностоп"],aspects:["hypertrophy","strength","endurance","maintenance","general_fitness","weight_management"]},
 {name:"Жим гантелей лёжа",tags:["gym","home"],muscleGroups:["chest","triceps","shoulders"],focus:"chest",pattern:"horizontal_push",equipment:["гантел"],blocked:["плеч","локт"],aspects:["hypertrophy","strength","maintenance"]},
